...
用户使用 Agent 的轨迹中，只有“读到了什么”，缺少“没读到什么”。
对用户环境中的可获取但没获取到的信息，Harness 能提供什么帮助？

设想：允许 session 隐式 fork，尝试不一样的路径

- 环境也需要 fork，而云端 session 才能实现
...
- 类比：Windows COM 规定了一套系统级的程序间实时交互标准
